...
const es: Record<TranslationKey, string> = {
  ...
  "email.fromAddress": "Correo del Remitente",
  "email.fromAddressPlaceholder": "scout@tudominio.com",
  "email.fromAddressHelp": "Los reportes se envian desde esta direccion. Debe ser un remitente verificado en Resend.",
